...
export const projectDetails: Record<string, ProjectDetail> = {
  medical: {
    ...
    images: ["/images/profile-portrait.jpg", "/images/track-and-field-2.jpg"],
  ...
  "vr-ai": {
    ...
    images: ["/images/photography-2.jpg", "/images/photography-3.jpg"],
  ...
  robotics: {
    ...
    images: ["/images/arduino-robot.jpg"],
